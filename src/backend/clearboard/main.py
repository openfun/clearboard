...
from . import config
from . import process1, process2, process3, process4
        ...
        while True:
            ...
            if (os.path.isfile(os.path.abspath('./clearboard/img_test.jpg')) and (temps != os.path.getctime('./clearboard/img_test.jpg'))):
                ...
                try:
                    ...
                    c = None
                parallax.crop("./clearboard/img_test.jpg", c, "./cropped_reoriented.jpg")
...
async def post_coord(coordinates: Coordinates):
    ...
    try:
        start = time.time()
        parallax.crop('./clearboard/img_test.jpg', co, "./cropped_reoriented.jpg")
        end = time.time()
